var t=globalThis,e={},o={},s=t.parcelRequire46ec;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in o){var s=o[t];delete o[t];var r={id:t,exports:{}};return e[t]=r,s.call(r.exports,r,r.exports),r.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){o[t]=e},t.parcelRequire46ec=s);var r=s.register;r("1qv28",function(t,e){async function o(t){try{let e=await fetch("https://food-boutique.b.goit.study/api/subscription",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t})});if(400===e.status){document.getElementById("footer-modal-content").classList.remove("footer-modal-content-modi-height"),document.getElementById("footer-modal-center-div").classList.remove("footer-modal-center-div-modi-margin"),document.getElementById("footer-modal-content").classList.add("footer-modal-content-height"),document.getElementById("footer-modal-center-div").classList.add("footer-modal-center-div-margin"),document.getElementById("footer-modal-image").style.display="none",document.getElementById("footer-modal-title").innerHTML='Service  <span style="color:#6D8434;">not found</span> (400)',document.getElementById("footer-modal-text").textContent="Check your email address and try again.";return}let o=await e.json();!1===o.success&&o.message&&o.message.includes("already exists")?(document.getElementById("footer-modal-content").classList.remove("footer-modal-content-height"),document.getElementById("footer-modal-center-div").classList.remove("footer-modal-center-div-height"),document.getElementById("footer-modal-center-div").classList.remove("footer-modal-center-div-margin"),document.getElementById("footer-modal-content").classList.add("footer-modal-content-modi-height"),document.getElementById("footer-modal-center-div").classList.add("footer-modal-center-div-modi-height"),document.getElementById("footer-modal-center-div").classList.add("footer-modal-center-div-modi-margin"),document.getElementById("footer-modal-image").style.display="none",document.getElementById("footer-modal-title").innerHTML='This <span style="color:#6D8434;">email address</span> has already been entered',document.getElementById("footer-modal-text").textContent="You have already subscribed to our new products. Watch for offers at the mailing address."):(document.getElementById("footer-modal-content").classList.remove("footer-modal-content-modi-height"),document.getElementById("footer-modal-center-div").classList.remove("footer-modal-center-div-modi-height"),document.getElementById("footer-modal-center-div").classList.remove("footer-modal-center-div-modi-margin"),document.getElementById("footer-modal-content").classList.add("footer-modal-content-height"),document.getElementById("footer-modal-center-div").classList.add("footer-modal-center-div-height"),document.getElementById("footer-modal-center-div").classList.add("footer-modal-center-div-margin"),document.getElementById("footer-modal-image").style.display="block",document.getElementById("footer-modal-title").innerHTML='Thanks for subscribing for <span style="color:#6D8434;">new</span> products',document.getElementById("footer-modal-text").textContent="We promise you organic and high-quality products that will meet your expectations. Please stay with us and we promise you many pleasant surprises.",document.getElementById("footer-modal-center-div").style.marginTop="100px")}catch(t){document.getElementById("footer-modal-title").textContent="Network error",document.getElementById("footer-modal-text").textContent="Please check your connection and try again.",console.error("API ERROR",t)}}window.greetFooterSubscribe=function(){let t=document.getElementById("footer-input"),e=t?t.value.trim():"";if(e)t.classList.remove("error"),t.placeholder="Email";else{t.classList.add("error"),t.value="",t.placeholder="Please enter your email";return}o(e),openFooterModal()},window.closeFooterModal=function(){document.getElementById("footer-modal").style.display="none"},window.openFooterModal=function(){document.getElementById("footer-modal").style.display="flex"}}),r("j9aeS",function(t,e){let o=JSON.parse(localStorage.getItem("products"))??[];document.querySelector(".header__cart--link").textContent=`Cart (${o.length})`}),s("j9aeS");const a=async(t,e,o,s)=>{try{return await fetch(`https://food-boutique.b.goit.study/api/products?keyword=${t}${s}&category=${e}&page=${o}&limit=9`).then(t=>t.json())}catch(t){return t}};let n="",c="",i="";const d=(t,e,o,s)=>{if(e.includes("&")){document.querySelector("#products-list").innerHTML=`
      <div class="products__nocards">
        ...
        </div>`,document.querySelector("#pagination-section").classList.add("display-none");return}document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:o,category:s,size:r,price:a,is10PercentOff:n,popularity:c})=>`
      ...
      </li>`).join(""),document.querySelector("#pagination-section").classList.remove("display-none")})};document.querySelector("#filters-alphabet-list").addEventListener("click",t=>{let e=t.currentTarget.querySelector(".filters__item--checked");e&&e.classList.remove("filters__item--checked"),t.target.classList.add("filters__item--checked"),t.currentTarget.classList.add("is-hidden"),document.querySelector("#filters-alphabet-text").textContent=t.target.textContent,i="allAlphabet"===t.target.id?"":t.target.id,d(n,c,1,i)}),document.querySelector("#filters-form").addEventListener("submit",t=>{t.preventDefault(),d(n=document.querySelector("#filters-input").value.trim(),c,1,i)}),document.querySelector("#filters-categories").addEventListener("click",t=>{t.currentTarget.nextElementSibling.classList.toggle("is-hidden")}),document.querySelector("#filters-categories-list").addEventListener("click",t=>{let e=t.currentTarget.querySelector(".filters__item--checked");e&&e.classList.remove("filters__item--checked"),t.target.classList.add("filters__item--checked"),t.currentTarget.classList.add("is-hidden"),document.querySelector("#filters-categories-text").textContent=t.target.textContent,c="all"===t.target.id?"":t.target.id,d(n,c,1,i)}),document.querySelector("#filters-alphabet").addEventListener("click",t=>{t.currentTarget.nextElementSibling.classList.toggle("is-hidden")});const l=document.querySelector("#products-list");a("","",1,"").then(t=>{l.innerHTML=t.results.map(({_id:t,name:e,img:o,category:s,size:r,price:a,is10PercentOff:n,popularity:c})=>`
        <li id="${t}" data-product="true" class="products__item">
          ...
          <div class="products__svg_price">
            <p class="products__price">$${a}</p>
            <button data-productadd="true" class="products__svg_btn">
              ${JSON.parse(localStorage.getItem("products")||"[]").includes(t)?"✓":`<svg class="products__basket">
                       <use href="#cart"></use>
                     </svg>`}
            </button>
          </div>
        </li>`).join("")}),(async()=>{try{return await fetch("https://food-boutique.b.goit.study/api/products/popular").then(t=>t.json())}catch(t){return t}})().then(t=>{JSON.parse(localStorage.getItem("products")||"[]"),document.querySelector("#popular__list").innerHTML=t.map(({_id:t,name:e,img:o,category:s,size:r,is10PercentOff:a,popularity:n})=>`<li id='${t}' data-product='true' class="popular__item">
          ...
          <div class="popular__text">
            ...
            <ul class="popular__points">
              ...
              <li class="popular__point">
                Popularity: <span class="popular__span">${n}</span>
              </li>
            </ul>
          </div>
          <button data-productadd='true' class="popular__cart">
            ${JSON.parse(localStorage.getItem("products")||"[]").includes(t)?"✓":`<svg class="popular__icon" width="12" height="12">
              <use href="#cart"></use>
            </svg>`}
          </button>
        </li>`).join("")}),(async()=>{try{return await fetch("https://food-boutique.b.goit.study/api/products/discount").then(t=>t.json())}catch(t){return t}})().then(t=>{let e=document.querySelector(".discount__list"),o=JSON.parse(localStorage.getItem("products")||"[]").map(t=>t.id);e.innerHTML=t.slice(0,2).map(t=>(o.includes(t._id),`
        ...
        <div class="discount__svg-price">
          ...
          <div class="discount__item-wrap">
            ...
            <button data-productadd="true" class="discount__svg-container">
              ${JSON.parse(localStorage.getItem("products")||"[]").includes(t._id)?"✓":`<svg class="discount__basket">
                      <use href="#cart"></use>
                    </svg>`}
            </button>
          </div>
    ...
    `)).join("")});let u=1;const p=(t,e,o,s)=>{a(o,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:o,category:s,size:r,price:a,is10PercentOff:n,popularity:c})=>`<li id="${t}" data-product="true" class="products__item">
        ${n?`<div class="products__green">
  <svg class="products__discount" width="54" height="54">
    <use href="#discount"></use>
            ...
            </li>`).join("")})},m=(t,e,o,s)=>{a(o,e,t,s).then(({totalPages:e})=>{let o="";for(let s=t;s<=e&&s<=t+3;s+=1)o+=`<li id='${s}' class="pagination__item ${t===s?"pagination__accent":""}">
        <button class="pagination__btn">${s}
        </button>
      </li>`;e>4&&(o+=`<li class="pagination__item">
        <p class="pagination__text">...</p>
      </li>`),document.querySelector("#pagination-list").innerHTML=o,t-2<1?document.querySelector("#double-prev").classList.add("pagination__disable"):document.querySelector("#double-prev").classList.remove("pagination__disable"),t-1<1?document.querySelector("#prev").classList.add("pagination__disable"):document.querySelector("#prev").classList.remove("pagination__disable"),t+2>e?document.querySelector("#double-next").classList.add("pagination__disable"):document.querySelector("#double-next").classList.remove("pagination__disable"),t+1>e?document.querySelector("#next").classList.add("pagination__disable"):document.querySelector("#next").classList.remove("pagination__disable")})};m(1,c,n,i),document.querySelector("#pagination-list").addEventListener("click",t=>{t.target.classList.contains("pagination__btn")&&Number.parseInt(t.target.parentElement.id)!==u&&(m(u=Number.parseInt(t.target.parentElement.id),c,n,i),p(u,c,n,i))}),document.querySelector("#next").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(m(u+=1,c,n,i),p(u,c,n,i))}),document.querySelector("#double-next").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(m(u+=2,c,n,i),p(u,c,n,i))}),document.querySelector("#prev").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(m(u-=1,c,n,i),p(u,c,n,i))}),document.querySelector("#double-prev").addEventListener("click",t=>{t.currentTarget.classList.contains("pagination__disable")||(m(u-=2,c,n,i),p(u,c,n,i))}),document.querySelector("#filters-form").addEventListener("submit",t=>{m(u=1,c,n,i)}),document.querySelector("#filters-categories-list").addEventListener("click",t=>{m(u=1,c,n,i)}),document.querySelector("#filters-alphabet-list").addEventListener("click",t=>{m(u=1,c,n,i)}),s("1qv28"),window.openProductModal=async function(t){let e=await fetch(`https://food-boutique.b.goit.study/api/products/${t}`),o=await e.json();document.getElementById("product-modal-image").src=o.img,document.getElementById("product-modal-image").alt=o.name,document.getElementById("product-modal-title").textContent=o.name,document.querySelector(".product-modal-button").id=t;let s=document.querySelectorAll(".product-modal-property");s&&(s[0].innerHTML=`<span style="color:#0101014D;">Category:</span> ${o.category.replace("_"," ")}`,s[1].innerHTML=`<span style="color:#0101014D;">Size:</span> ${o.size}`,s[2].innerHTML=`<span style="color:#0101014D;">Popularity:</span> ${o.popularity}`),document.querySelector(".product-modal-desc").textContent=o.desc,document.querySelector(".product-modal-price").textContent=`$${o.price}`,document.getElementById("product-modal").style.display="flex"},window.closeProductModal=function(){document.getElementById("product-modal").style.display="none",location.reload()},document.addEventListener("click",function(t){if(t.target.classList.contains("products__container_img")||t.target.classList.contains("products__img")){let e=t.target.closest("li");e&&e.id&&openProductModal(e.id)}else if(t.target.classList.contains("products__svg_btn")||t.target.parentNode.classList.contains("products__svg_btn")||t.target.parentNode.parentNode.classList.contains("products__svg_btn")){let e=JSON.parse(localStorage.getItem("products"))??[],o=t.target.closest("li"),s=o.id,r=o.querySelector(".products__svg_btn");e.includes(s)?(e=e.filter(t=>t!==s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`
      <svg class="products__basket">
        <use href="#cart"></use>
      </svg>
    `):(e.push(s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`\u{2713}`)}else if(t.target.classList.contains("discount__svg-container")||t.target.parentNode.classList.contains("discount__svg-container")||t.target.parentNode.parentNode.classList.contains("discount__svg-container")){let e=JSON.parse(localStorage.getItem("products"))??[],o=t.target.closest("li"),s=o.id,r=o.querySelector(".discount__svg-container");console.log("aaaa"),e.includes(s)?(e=e.filter(t=>t!==s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`
      <svg class="products__basket">
        <use href="#cart"></use>
      </svg>
    `):(e.push(s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`\u{2713}`)}else if(t.target.classList.contains("popular__cart")||t.target.parentNode?.classList.contains("popular__cart")){let e=JSON.parse(localStorage.getItem("products"))??[],o=t.target.closest("li"),s=o.id,r=o.querySelector(".popular__cart");e.includes(s)?(e=e.filter(t=>t!==s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`
      <svg class="popular__icon" width="12" height="12">
        <use href="#cart"></use>
      </svg>
    `):(e.push(s),localStorage.setItem("products",JSON.stringify(e)),r.innerHTML=`\u{2713}`)}}),document.querySelector(".product-modal-button").addEventListener("click",t=>{let e=JSON.parse(localStorage.getItem("products"))??[],o=t.target.closest("button").id;e.includes(o)?(e=e.filter(t=>t!==o),localStorage.setItem("products",JSON.stringify(e)),document.querySelector(".product-modal-text").textContent="Add to"):(e.push(o),localStorage.setItem("products",JSON.stringify(e)),document.querySelector(".product-modal-text").textContent="Remove from")});
//# sourceMappingURL=FoodBoutique.f21f7406.js.map
