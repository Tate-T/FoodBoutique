var t=globalThis,e={},o={},s=t.parcelRequire46ec;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in o){var s=o[t];delete o[t];var a={id:t,exports:{}};return e[t]=a,s.call(a.exports,a,a.exports),a.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){o[t]=e},t.parcelRequire46ec=s);var a=s.register;a("lgck5",function(t,e){s("fMbCU"),localStorage.getItem("cart")||localStorage.setItem("cart",JSON.stringify([]))}),a("fMbCU",function(t,e){});const r=async(t,e,o,s)=>{try{return await fetch(`https://food-boutique.b.goit.study/api/products?keyword=${t}${s}&category=${e}&page=${o}&limit=9`).then(t=>t.json())}catch(t){return t}};let n="",c="",i="";const d=(t,e,o,s)=>{if(e.includes("&")){document.querySelector("#products-list").innerHTML=`
      ...
      </div>`,document.querySelector("#pagination-section").classList.add("display-none");return}r(t,e,o,s).then(t=>{if(0===t.results.length){document.querySelector("#products-list").innerHTML=`
        <div class="products__nocards">
          <h3 class="products__notitle">
    ...
    `}).join("")});let u=1;const p=(t,e,o,s)=>{r(o,e,t,s).then(t=>{document.querySelector("#products-list").innerHTML=t.results.map(({_id:t,name:e,img:o,category:s,size:a,price:r,is10PercentOff:n,popularity:c})=>`<li id="${t}" data-product="true" class="products__item">
        ${n?`<div class="products__green">
